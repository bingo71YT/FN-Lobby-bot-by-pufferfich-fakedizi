...
Copyright pufferfich/fake dizi 2029
...
print(color.CYAN + f' PUFFI BOT')

print(color.CYAN + f' BY FAKE DIZI AKA PUFFERFICH')

print(color.CYAN + f' USE CODE YT-DIZI')
...
async def event_party_invite(invite):
    ...
    if data['joinoninvite'].lower() == 'true':
        ...
        if invite.sender.display_name not in data['BlockList']:
            ...
            try:
                ...
                print(Fore.GREEN + f' [puffi bot] [{getTime()}] Accepted party invite from {invite.sender.display_name}')
            ...
            print(Fore.GREEN + f' [puffi bot] [{getTime()}] Never accepted party invite from' + Fore.RED + f' {invite.sender.display_name}')
    ...
    if data['joinoninvite'].lower() == 'false':
        ...
        if invite.sender.display_name in data['FullAccess']:
            ...
            print(Fore.GREEN + f' [puffi bot] [{getTime()}] Never accepted party invite from {invite.sender.display_name}')
...
async def event_friend_request(request):
    ...
    if data['friendaccept'].lower() == 'true':
        ...
        if request.display_name not in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] Accepted friend request from: {request.display_name}")
            ...
            print(f" [puffi bot] [{getTime()}] Never Accepted friend reqest from: " + Fore.RED + f"{request.display_name}")
    ...
    if data['friendaccept'].lower() == 'false':
        ...
        if request.display_name in data['FullAccess']:
            ...
            print(f" [puffi bot] [{getTime()}] Never accepted friend request from: {request.display_name}")
...
async def event_party_member_join(member):
    ...
    if client.user.display_name != member.display_name:
        ...
        print(f" [puffi bot] [{getTime()}] {member.display_name} has joined the lobby.")
